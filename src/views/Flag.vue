<template>
    ...
    <div class="md:flex-row flex-col flex justify-between space-x-48 items-center mt-10 mx-24">
        <div class="md:w-1/2">
            <img class="w-full" :src="country.flags.png" />
        </div>
        <div class="md:w-1/2 float-right">
            <h3 class="text-2xl font-semibold pb-6 dark:text-white text-DarkMode-dark-blue">{{ country.name.common }}</h3>
            ...
            <div class="mt-10 flex space-x-2">
                <div class="text-sm dark:text-white text-DarkMode-dark-blue pr-2">Border Countries:</div>
